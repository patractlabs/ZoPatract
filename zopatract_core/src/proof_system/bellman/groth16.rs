...
use zopatract_field::BellmanFieldExtensions;
...
const G16_WARNING: &str = "WARNING: You are using the G16 scheme which is subject to malleability. See zopatract.github.io/toolbox/proving_schemes.html#g16-malleability for implications.";
