...
use std::fmt;
use zopatract_core::typed_absy::{Type, UBitwidth};
...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Error::Conversion(e) => write!(f, "Invalid ZoPatract values: {}", e),
...
mod tests {
    ...
    mod strict {
        use super::*;
        use zopatract_core::typed_absy::types::{StructMember, StructType};
